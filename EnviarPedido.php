                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse myCollapse">
                            <ul class='nav navbar-nav'>
                                ...
                                <li><a href="crud/add.php">Novo Pedido</a></li>-->
                            </ul>
                        </div>
                    </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="inner text-center"> <!-- centraliza os textos -->
                            <h1 class="logo-name">Pedido Realizado com Sucesso !</h1>
                            <h2>Obrigado pela Preferência</h2>
                            <p>Em Alguns Minutos seu Pedido sera Entregue !!!</p>
                            <div class="col-md-12">
                                <a href="crud/add.php" class="btn btn-primary">Novo Pedido</a>
                                <a href="principal.php" class="btn btn-default">Página Inicial</a>
                            </div>
                        </div>
                    </div>
                </div>
